      ...
      <div className="container mx-auto">
        ...
        <div>
          <p className="text-lg font-medium my-10 text-justify text-slate-700">
            ...
            participate in and/or interact with market research activities
            (including online and mobile surveys, product tests, focus groups,
            and more), various advertising, content, shopping opportunities,
            special offers, coupons, location-based deals, and other rewards
            opportunities.
            <br />
            <br />
            These terms are subject to change. For more information on how we
            use the data you provide, please see our Privacy Policy.
            <br />
            <br />
            <span className="text-slate-600">
              These General Terms & Conditions/Terms of Use include a class
              action waiver and a waiver of jury trials and require binding
          ...
          <div className="mb-10 text-justify">
            ...
            <p className="mb-10">
              ...
              non-commercial use. You may use the Applications/Services only
              when and as available. The Applications/Services are only
              available to individuals who are seventeen (17) years of age or
              older residing in the United States. Participation on the Panel is
              limited to only one (1) account per person. From time to time our
              clients may want to survey the opinion of minors, they may only
          ...
          <div className="mb-10 text-justify">
            ...
            <p className="mb-10">
              ...
              membership with the Panel associated with the Website(s) and
              without providing or disclosing personal information.
            </p>
            <p className="mb-10">
            ...
            <p className="mb-10">
              ...
              responsible for keeping it safe. We will not be liable for any
              unauthorized use of your account, which includes unauthorized use
              of your email address, password and reward redemption.
            </p>
            <p className="mb-10">
          ...
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">5. Unauthorized Uses</h3>
            <p className="mb-10">
              You agree not to: (i) use spiders, robots or other automated data
              mining techniques to catalogue, download, store or otherwise
              reproduce or distribute data or content available in connection
              with the Applications/Services, or to manipulate the results of
              any survey, prize draw or contest; (ii) take any action to
              interfere with any Website(s) or an individual’s use of any
              Website, including, but not limited to, by overloading,
              “flooding”, “mail bombing” or “crashing” any Website; (iii) send
              or transmit any viruses, corrupted data or any other harmful,
              disruptive or destructive code, file or information, including,
              but not limited to, spyware; (iv) collect any personally
              identifiable information of or about any other user of the
              Applications/Services; (v) send unsolicited emails, including, but
              not limited to, promotions and/or advertising of products or
              services; (vi) open, use, or maintain more than one (1) membership
              account with a Panel; (vii) Forge or mask your true identity;
              (viii) frame a portion(s) of any Website within another website or
              ...
              speeding through surveys, taking the same survey more than once,
              masking or forging your identity, submitting false information
              during the registration process, submitting false or untrue survey
              data, redeeming or attempting to redeem rewards, prizes and/or
              incentives through false or fraudulent means, and tampering with
              surveys; (xii) reverse engineer any aspect of the
              ...
              measurers or controls utilized to prohibit, restrict or limit
              access to any webpage, content or code, except as expressly
            ...
            <p>
              ...
              . In connection with your use of the Applications/Services, you
              may be asked to verify your identity through our third party ID
              verification service provider's platform.In all cases, such
              service providers shall be subject to appropriate agreements
              concerning data processing, confidentiality, etc.
            </p>
          </div>
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">6. Restricted Content</h3>
            <p>
              ...
              Content. You agree to protect the confidentiality and secrecy of
              the Restricted Content and you agree not to modify, copy,
          ...
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">7. User Content</h3>

            <p className="mb-10">
              You are solely liable and responsible for all content, materials,
              information and comments you use, upload, post or submit in
              connection with the Applications/Services (“User Content”). You
              are solely responsible for all third party approvals, consents
              ...
              or material of any third party. User Content should not include
            ...
            <p className="mb-10">
              ...
              distribute your User Content in any manner, without compensation
              or notice.
            </p>
            <p className="">
          ...
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">8. Rewards Programs</h3>

            <p className="mb-10">
              A. In connection with your use of the Applications/Services, you
              may have the opportunity to accumulate rewards, incentives and
              entries into prize draws or sweepstakes. Incentives may be in the
              form of points or program/panel currency (“Panel Currency”). Panel
              Currency has no monetary value and cannot be redeemed for cash;
              Panel Currency may not be auctioned, traded, bartered or sold and
              is not transferrable upon death, by gift, as part of a domestic
              relations matter, or otherwise, except by operation of law.
              Information, official rules and terms and conditions for rewards,
              incentives and prize draws or sweepstakes may be available in
              these Terms, on the Website for a Panel, at the beginning or end
            ...
            <p className="mb-10">
              ...
              participation in the Research or other activity on a Panel is not
              calculated based on time spent by you. Similarly, any
              consideration paid to or points earned by you for participation is
              not pro-rated on an hourly basis or otherwise.
            </p>
            <p className="mb-10">
              ...
              member accounts are not actual bank or financial accounts and do
              not accrue or accumulate interest of any kind.
            </p>
            <p className="mb-10">
            ...
            <p className="mb-10">
              F. Redemption (1) Points or Panel Currency will be deducted from
              the Panel member's account at the time the redemption request is
            ...
            <p className="mb-10">
              ...
              or Panel Currency belonging to any other member, including, but
            ...
            <p className="mb-10">
              ...
              Virtual Mastercard® and Visa®, and that such verification may
              require you to provide your date of birth, tax identification
            ...
            <p className="mb-10">
              O. Your daily limit on the redemption of points or Panel Currency
          ...
          <div className="mb-10 text-justify">
            ...
            <p>
              ...
              Panel member may update, correct and/or delete information
              contained in his or her membership profile by: (i) accessing his
              or her Panel membership account; or (ii) sending an email to the
              appropriate Panel member services team for the appropriate Panel.
            </p>
          </div>
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">10. Opt-Out Policy</h3>
            <p>
          ...
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">11. Links</h3>
            <p>
          ...
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">13. Disclaimer</h3>
            <p>
              ...
              THE SYSTEMS OR THE SERVER(S) THAT SUPPORT THE
              APPLICATIONS/SERVICES AND MAKE THE APPLICATIONS/SERVICES AVAILABLE
          ...
          <div className="mb-10 text-justify">
            ...
            <p>
              ...
              Applications/Services does and will to constitute your acceptance
          ...
          <div className="mb-10 text-justify">
            ...
            <p className=" font-medium text-gray-500">
              ...
              THE APPLICATIONS/SERVICES AND/OR THESE TERMS MUST BE FILED WITHIN
          ...
          <div className="mb-10 text-justify">
            ...
            <p>
              You acknowledge and agree that you will comply with all applicable
              international, national, Federal, state and/or local laws, codes,
              regulations, rules and/or requirements (“Applicable Laws”)
              regarding your use of, participation, in, and/or access to the
              Applications/Services.
            </p>
          </div>
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">
              18. Suspension; Termination; De-Activation of Panel Membership
              Accounts
            </h3>

            <p className="mb-10">
              Either party may terminate your membership with a Panel at any
              time, with or without cause, for any reason or for no reason, and
            ...
            <p className="mb-10">
              ...
              termination; (ii) your membership will immediately be cancelled;
              and (iii) your access to, participation in and use of the
              Applications/Services (including, but not limited to,
              participation in survey projects) will immediately cease.
            </p>
            <p className="mb-10">
              In the event that a non-Panel member breaches or otherwise
              violates these Terms, such non-Panel member hereby agrees that:
              (a) all rights, title and interest in and/or to all unredeemed
              rewards, incentives and/or prizes (if any), shall be forfeit
              effective immediately upon termination; and (b) access to, use of,
              and participation in the Applications/Services will immediately
              cease.
            </p>
            <p className="mb-10">
            ...
            <p className="mb-10">
              ...
              following the effective date of termination or deactivation of
              your account. Termination or deactivation of your membership will
              not delete or remove any application(s).
            </p>
          </div>
          <div className="mb-10 text-justify">
            ...
            <p className="mb-10">
              ...
              Section 19, the term “Immediate Family Member(s)” includes
              parents, spouses, children or significant others (i.e.
              girlfriends/boyfriends, domestic partners and spousal
              equivalents).
            </p>
            <p className="mb-10">
          ...
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">
              21. Governing Laws; Jurisdiction and Venue
            </h3>
            <p>
              These Terms and your access to, use of or participation in the
              Applications/Services shall be governed by and construed in
              accordance with the laws of the state of Connecticut, USA, without
              regard to any portion of any choice of law principles (whether
              those of Connecticut or any other jurisdiction) that might provide
              for application of a different jurisdiction’s laws. All claims or
              disputes arising in connection with these Terms and/or your access
              to, use of or participation in the Applications/Services shall be
              subject to the exclusive jurisdiction of the state or Federal
              courts located in Fairfield County, Connecticut, USA.
            </p>
          </div>
          <div className="mb-10 text-justify">
            <h3 className="text-lg font-medium mb-2">
